        ...
        for query in queries2analyze:
            ...
            if where_clause is not None:
                ...
                for conjunct in conjuncts:
                    ...
                    elif isinstance(alias, tuple): #ADDED
                        la, lc, ra, rc = alias
                        if la in aliases and ra in aliases:
                            cross_table_predicates.append(
                                SimpleNamespace(
                                    left_alias=la, left_column=lc,
                                    right_alias=ra, right_column=rc))
        
        self.cross_table_predicates = cross_table_predicates
        ...
        if isinstance(expression, exp.Binary):
            ...
            if isinstance(left_input, exp.Column) and \
                ...
                if (left_table == right_table):
                    ...
                    return (left_table, left_input.name,
                            right_table, right_input.name)
